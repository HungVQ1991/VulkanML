...
public:
    virtual ~ICost_Function() noexcept = default;
     ...
     virtual float computeLoss(const Matrix &_prediction_matrix, const Matrix &_target_matrix) const = 0;
     virtual Matrix computeGradient(const Matrix &_prediction_matrix, const Matrix &_target_matrix) const = 0;
