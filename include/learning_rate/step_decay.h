...
public:
    Step_Decay(float _initial_learning_rate = 0.001f,
    ...
    int getStepSize() const noexcept { return step_size; }
    ...
    void setStepSize(int _step_size) noexcept { step_size = _step_size; }
};